                ...
                <div class="col-md-3">
                    <aside class="sidebar">
                        <ul class="nav nav-list mb-xlg">
                            ...
                            <li class="active"><a href="?pag=concurso_jardineiro">Jardineiro</a></li>
                        </ul>    
                    </aside>
                </div>      
                <div class="col-md-9">
                    <h2>Concurso | Jardineiro</h2>
                    <hr class="tall">
                    <div class="row">
                        <div class="row">
                            <?php
                            $connected = mysqli_connect('192.168.1.14:3306', 'matabala', 'matabala', 'db_site_mees');
                            $noticias = mysqli_query($connected, "select ID, TITULO, TEXTO,IMAGEN, ESTADO,CONCURSO,DATA_REG from view_ver_concurso  WHERE CONCURSO='jardineiro' ");
