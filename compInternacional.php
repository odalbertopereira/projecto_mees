        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Compromissos Internacionais</li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <h1>Compromissos Internacionais</h1>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-md-3">
                    <aside class="sidebar">
                        <ul class="nav nav-list mb-xlg">
                            ...
                            <li class="active"><a href="?pag=compInternacional">Compromissos Internacionais</a></li>

                        </ul>    
                    </aside>
                </div>      
                <div class="col-md-9">
                    <h2>Compromissos Internacionais</h2>
                    <hr class="tall">
                    <div class="row">
