    ...
    <div class="container">
        <div class=" diagnostc col-md-12">
            <div class="row">
                <div class="col-md-3">
                    <aside class="sidebar">
                        <ul class="nav nav-list mb-xlg">
                            <li class="active"><a href="?pag=concurso_professor">Professores</a></li>
                ...
                <div class="col-md-9">
                    <h2>Concurso | Professor</h2>
                    <hr class="tall">
                    <div class="row">
                        <div class="row">
                            <?php
                            $connected = mysqli_connect('192.168.1.14:3306', 'matabala', 'matabala', 'db_site_mees');
                            $noticias = mysqli_query($connected, "select ID, TITULO, TEXTO,IMAGEN, ESTADO,CONCURSO,DATA_REG from view_ver_concurso  WHERE CONCURSO='professor' ");
