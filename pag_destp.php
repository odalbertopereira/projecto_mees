    ...
    <div class="container">
        <div class=" diagnostc col-md-12">
            <div class="row">
                                ...
                                <ul>
                                    <div class="dropdown-mega-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <span class="dropdown-mega-sub-title"><a href="?pag=destp" data-plugin-tooltip="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Direcção do Ensino Secundário e Tecnico Profissional"><b>DESTP</b></a></span>
                                            </div>
                                            <div class="col-md-6">
                ...
                <div class="col-md-9">
                    <h2>DESTP - Direcção do Ensino Secundário e Tecnico Profissional</h2>
                    <hr class="tall">
                    <div class="row">
