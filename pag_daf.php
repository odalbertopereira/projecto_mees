    ...
    <div class="container">
        <div class=" diagnostc col-md-12">
            <div class="row">
                                ...
                                <ul>
                                    <div class="dropdown-mega-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <span class="dropdown-mega-sub-title"><a href="?pag=daf" data-plugin-tooltip="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Direcção Administrativa e Finaceira"><b>DAF</b></a></span>
                                            </div>
                                            <div class="col-md-6">
                ...
                <div class="col-md-9">
                    <h2>DAF - Direcção Administrativa e Finaceira</h2>
                    <hr class="tall">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p class="justificar_texto">
                                                1. A Direcção de Administração Educativa é o serviço central do Ministério a qual cabe a coordenação dos equipamentos e 
                                                gestão dos estabelecimentos de educação pré-escolar e dos ensinos básico e secundário,
                                                bem como a definição de uma política de acção social escolar e de educação para a saúde.
                                            </p>
                                            <img class="pull-left img-responsive" width="300" height="211" src="img/direcoes/Imagem1DAF.png" alt="Device">
