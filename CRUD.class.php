...
class CRUD extends ConDB {
    ...
    public function contar_dados_pdo($valor_cont, $tabla_view, $cond) {
        $connectd = mysqli_connect("localhost:3306", "bandido", "bandido@ad", "db_sitemees") or die("Falha ao selecionar o banco");
...
class CRUDMYSQLI {
    ...
    public function select_function($nome_func, $fields) {
        $connectd = mysqli_connect("localhost", "bandido", "bandido@ad", "db_sitemees") or die("Falha ao selecionar o banco");
